  ...
  return (
    <div className="flex gap-4 mb-8 justify-between">
      <div className="flex flex-col gap-2">
        ...
        >
          <Skeleton className="h-10 w-48 bg-gray-200 animate-pulse" />
        </MotionH1>
        <MotionDiv
          variants={itemVariants}
          initial="hidden"
        ...
        >
          <Skeleton className="h-6 w-96 bg-gray-200 animate-pulse" />
        </MotionDiv>
      </div>
      <MotionDiv
        variants={itemVariants}
...
function SummaryCardSkeleton() {
  return (
    ...
    >
      <Skeleton className="h-48 w-full rounded-lg bg-gray-200 animate-pulse" />
    </MotionDiv>
  );
}
